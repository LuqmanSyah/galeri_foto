  ...
  <div class="d-flex justify-content-center">
    <div class="w-50 my-3 p-1 rounded shadow-lg">
      <div class="d-flex justify-content-between align-items-center">
        <a href="#" class="ms-3 mt-3 mb-4 d-flex justify-content-start align-items-center mb-2 text-decoration-none">
          <img src="https://dummyimage.com/640x1:1/" alt="profile-picture" class="img-fluid rounded-circle" width="50">
          <span class="ms-2 fs-5 text-dark">{{ $photo->user->nama }}</span>
        </a>
        <p class="text-muted fs-6 me-3">{{ date('d-m-Y', strtotime($photo->created_at)) }}</p>
      </div>
      <img class="img-fluid mx-auto d-block" src="{{ asset($photo->lokasi_file) }}" alt="{{ $photo->judul_foto }}">
      ...
      <div id="post-detail" class="my-2 ms-3">
        <span class="fw-bold fs-5 d-block">{{ $photo->judul_foto }}</span>
